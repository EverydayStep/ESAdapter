#
#  Be sure to run `pod spec lint ESAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESAdapter.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESAdapter/ESAdapter/*.{h,m}"
